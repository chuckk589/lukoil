...
//     await this._em.populate(tasks, ['course', 'lesson', 'lesson.course', 'lesson.courseGroup', 'submissions', 'submissions.courseGroup']);
//   }
...
//   async findBySingleParent(creatorId: EntityId, courseId: EntityId, filters?: { draft?: boolean; noFutureAvailableDate?: boolean }, options?: IFindOptions<Task>): Promise<Counted<Task[]>> {
//     const scope = new TaskScope();
